...
export default function Tickets() {
  ...
  const [selectedTags, setSelectedTags] = useState<string[]>(() => {
    const saved = localStorage.getItem('closed_selectedTags');
    return saved ? JSON.parse(saved) : [];
  });
  const [sortBy, setSortBy] = useState<"createdAt" | "updatedAt">(() => {
    return (localStorage.getItem('closed_sortBy') as "createdAt" | "updatedAt") || "createdAt";
  });
  ...
  useEffect(() => {
    ...
    localStorage.setItem('closed_selectedTypes', JSON.stringify(selectedTypes));
    localStorage.setItem('closed_selectedTags', JSON.stringify(selectedTags));
    localStorage.setItem('closed_sortBy', sortBy);
